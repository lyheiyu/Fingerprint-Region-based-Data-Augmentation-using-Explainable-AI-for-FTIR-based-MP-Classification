...
def build_cam2(datas,n,PN):
    ...
    gmm = GMM(n_components=3).fit(clusterdata2)
...
from FTIR_fit_least_square import generatedataBySperateLSforEach3,\
    ...
    generatedataBySperateLSforEach8,generatedataBySperateLSforEach9,generatedataBySperateLSforEach10
import gc
...
if __name__ == '__main__':
    ...
    for seedNum in range(20):
        ...
        #
        #     labels=build_cam2(intensityForLoop,n,PN)
        ...
        #     #####SVM
        #     # indexForIntensity = idexes.take(range(0, 15), mode='wrap')
        #     #data2D, label = generatedataBySperateLSforEach10(waveLength, intensityforRandomLoop, n, firstIdx, lastIdx, 300)
        #     #####KNN
        #     indexForIntensity=idexes.take(range(0,15),mode='wrap')
    ...
    #utils.plot_confusion_matrix(cmTotal, PN, 'FRDA KNN')
